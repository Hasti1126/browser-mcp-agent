...
with st.sidebar:
    ...
    st.markdown("- Go to mcp-agent.com")
    ...
    st.markdown("- Navigate to docs, scroll down, and report details")
...
async def run_mcp_agent(message):
    if not os.getenv("GOOGLE_API_KEY"):
        return "Error: GOOGLE_API_KEY not provided"
...
if 'result' not in locals():
    st.markdown(
        ...
        <ol>
            <li>Enter your google gemmini API key in your mcp_agent.secrets.yaml file</li>
